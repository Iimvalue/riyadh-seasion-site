...
export default function SponsorsSection() {
  return (
    ...
    >
      ...
      {/* OFFICIAL PLATINUM PARTNERS */}
      <div className="mb-5 text-center">
        <p className="h5 fw-semibold">OFFICIAL PLATINUM PARTNERS</p>
      ...
      <div className="mb-5 text-center">
        <p className="h5 fw-semibold">OFFICIAL PREMIUM PARTNERS</p>
        <div className="d-flex flex-wrap justify-content-center gap-4">
          <img
      ...
      <div className="mb-5 text-center">
        <p className="h5 fw-semibold">OFFICIAL STRATEGIC PARTNERS</p>
        <div className="d-flex flex-wrap justify-content-center gap-4">
          <img
      ...
      <div className="mb-5 text-center">
        <p className="h5 fw-semibold">OFFICIAL MAIN PARTNERS</p>
        <div className="d-flex flex-wrap justify-content-center gap-4">
          <img
      ...
      <div className="mb-5 text-center">
        <p className="h5 fw-semibold">OFFICIAL AIRLINE PARTNER</p>
        <div className="d-flex flex-wrap justify-content-center gap-4">
          <img
      ...
      <div className="mb-5 text-center">
        <p className="h5 fw-semibold">OFFICIAL SOCIAL MEDIA PARTNER</p>
        <div className="d-flex flex-wrap justify-content-center gap-4">
          <img
      ...
      {/* OFFICIAL CO PARTNERS */}
      <div className="text-center">
        <p className="h5 fw-semibold">OFFICIAL CO PARTNERS</p>
        <div className="d-flex flex-wrap justify-content-center gap-4">
          <img
